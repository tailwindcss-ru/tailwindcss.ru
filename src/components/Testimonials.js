...
let testimonials = [
  ...
  [
    ...
    {
      content:
        'Я использую Tailwind CSS уже много лет, и тем не менее, они все еще каждый год удивляют нас обновлениями. Это помогло мне очень быстро создавать веб-сайты, я никогда не смогу вернуться к скучным старым классам CSS!',
    ...
    {
      content:
        'Получение одобрения Tailwind CSS от всей нашей команды разработчиков заняло некоторое время и обсуждение, но как только мы внедрили его в масштабах всей компании, любой разработчик смог без труда включиться в любой проект и быстро внести изменения/улучшения.',
    ...
    {
      content:
        "Tailwind CSS сам по себе стал самым большим и наиболее важным изменением в процессе разработки нашей команды. Я рад, что живу во вселенной, где существует Tailwind.",
  ...
  [
    ...
    {
      content:
        "Я никогда не чувствовал себя более уверенно при проектировании и оформлении веб-сайтов и веб-приложений, чем когда использовал Tailwind CSS.",
    ...
    {
      content: 'Использование Tailwind CSS заставит вас почувствовать, что вы только что разблокировали чит-код.',
