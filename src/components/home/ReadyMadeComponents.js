  ...
  return (
    <section id="ready-made-components">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Paragraph>
          Пользовательский интерфейс Tailwind - это набор красивых, полностью отзывчивых компонентов
          пользовательского интерфейса, спроектированных и разработанных нами, создателями Tailwind
          CSS. В нем есть сотни готовых примеров на выбор, и он гарантированно поможет вам найти
          идеальную отправную точку для того, что вы хотите создать.
        </Paragraph>
