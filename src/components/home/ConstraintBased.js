      ...
      {[
        ...
        >
          ...
          <div className={clsx('mt-2 sm:mt-3 lg:mt-2 xl:mt-3 text-gray-700', ...font)}>
            Быстрая коричневая лиса jumps over the lazy&nbsp;dog.
          </div>
        </motion.div>
      ))}
    </motion.div>
  ...
  return (
    <section id="constraint-based" className="relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Caption className="text-indigo-500">На основе ограничений</Caption>
        <BigText>
          <Widont>API для вашей дизайн-системы.</Widont>
        </BigText>
        <Paragraph>
          Служебные классы помогают вам работать в рамках ограничений системы, вместо того,
          чтобы захламлять ваши таблицы стилей произвольными значениями.
          Они позволяют легко согласовываться с выбором цвета, интервалом, типографикой,
          тенями и всем остальным, что составляет хорошо продуманную систему дизайна.
        </Paragraph>
        <Link href="/docs/utility-first" color="indigo">
          Подробнее<span className="sr-only">, основы утилит</span>
        </Link>
        <div className="mt-10">
          <Tabs
            tabs={tabs}
