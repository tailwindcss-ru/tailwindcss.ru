  ...
  return (
    <section id="dark-mode">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Paragraph>
          Не хотите быть одним из тех веб-сайтов, которые ослепляют людей,
          когда они открывают его на своем телефоне в 2 часа ночи?
          Включите темный режим в файле конфигурации, затем добавьте{' '}
          <InlineCode>dark:</InlineCode> перед любой цветовой утилитой,
          чтобы применить его, когда темный режим активен.
          Работает с цветами фона, цветами текста, цветами границ и даже градиентами.
        </Paragraph>
        <Link href="/docs/dark-mode" color="gray">
          Подробнее<span className="sr-only">, темный режим</span>
        </Link>
      </div>
      <GridLockup
