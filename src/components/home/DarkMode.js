    ...
    <section id="dark-mode">
      <div className="px-4 sm:px-6 md:px-8 mb-10 sm:mb-16 md:mb-20">
        ...
        <Paragraph className="mb-6">
          Не хотите быть одним из тех веб-сайтов, которые ослепляют людей, когда они открывают его на своем телефоне в 2 часа ночи?
          Включите темный режим в своем файле конфигурации, затем добавьте{' '}
          <InlineCode>dark:</InlineCode> перед любой цветовой утилитой, чтобы применить его, когда темный режим активен.
