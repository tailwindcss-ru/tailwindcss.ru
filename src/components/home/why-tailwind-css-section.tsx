  ...
  return (
    <div className="relative max-w-full">
      ...
      <GridContainer className="2xl:before:hidden 2xl:after:hidden">
        <CategoryHeader className="text-pink-500 dark:text-pink-400">Почему Tailwind CSS?</CategoryHeader>
      </GridContainer>
      ...
      <GridContainer>
        <p className="max-w-(--breakpoint-md) px-2 text-base/7 text-gray-600 max-sm:px-4 dark:text-gray-400">
          Tailwind без извинений современен и использует все последние и лучшие возможности CSS, чтобы сделать
          опыт разработки максимально приятным.
        </p>
      </GridContainer>
        ...
        <div className="grid w-full grid-flow-dense grid-cols-30 gap-2 bg-gray-950/5 p-2 dark:bg-white/10">
          <BentoItem className="col-span-full">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Хорошо, это не совсем передовой край, но просто добавьте размер экрана перед буквально любой утилитой, чтобы
                  применить её на определённой контрольной точке.
                </BentoDescription>
              </div>
            </BentoHeader>
                      ...
                      <div className="flex flex-1 flex-col">
                        <div className="relative mb-4 overflow-hidden rounded-lg @max-[theme(--breakpoint-xl)]:-mx-4 @max-[theme(--breakpoint-xl)]:-mt-4 @min-[theme(--breakpoint-lg)]:hidden">
                          ...
                          <div className="absolute inset-0 flex flex-col justify-end gap-2 bg-linear-to-b from-transparent via-transparent to-gray-950 p-6 @min-[theme(--breakpoint-sm)]:hidden">
                            ...
                            <span className="text-xl/6 font-semibold text-white">Пляжный дом на озере Гурон</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 @min-[theme(--breakpoint-sm)]:grid-cols-[1fr_auto] @min-[theme(--breakpoint-xl)]:grid-cols-1">
                          <div>
                            ...
                            <span className="mt-2 flex gap-2">
                              ...
                              <span className="text-sm/6 text-gray-500">(128 отзывов)</span>
                        ...
                        <div>
                          <p className="mt-4 line-clamp-2 text-sm/6 text-gray-600 @min-[theme(--breakpoint-xl)]:max-w-md dark:text-gray-400">
                            Эта солнечная и просторная комната для тех, кто путешествует налегке и ищет уютное и комфортное
                            место, чтобы положить голову на ночь...{" "}
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Что за веб-сайт в наши дни без нескольких размытий фона? Продолжайте накладывать фильтры, пока ваш дизайнер
                  не попросит вас, пожалуйста, остановиться.
                </BentoDescription>
              </div>
            </BentoHeader>
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>Тёмный режим</BentoTitle>
                <BentoDescription>
                  Если вы не фанат сжигания сетчатки, просто добавьте{" "}
                  <code className="font-medium text-gray-950 dark:text-white">dark:</code> перед любым цветом, чтобы
                  применить его в тёмном режиме.
                </BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
          ...
          <BentoItem className="col-span-full xl:col-span-18">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Цветовая палитра теперь использует более яркие цвета широкого диапазона без необходимости понимать, что
                  всё это даже означает.
                </BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              ...
              <div className="-mr-16 -mb-8 [--size:--spacing(48)] lg:flex lg:justify-center xl:block">
                <div className="-mt-18 sm:-mt-26">
                  <div className="bg-white p-6 ring ring-gray-950/5 sm:p-16 dark:bg-gray-950 dark:ring-white/10">
                    <h3 className="text-base/6 font-semibold text-gray-950 dark:text-white">Просмотр недвижимости</h3>
                    <div className="mt-6 grid grid-cols-[repeat(2,var(--size))] grid-rows-[repeat(3,var(--size))] gap-2 sm:grid-cols-[repeat(3,var(--size))] sm:grid-rows-[repeat(2,var(--size))]">
                      <div className="relative col-span-2 row-span-1 overflow-hidden rounded-t-2xl sm:col-span-1 sm:row-span-2 sm:rounded-none sm:rounded-l-2xl dark:outline dark:outline-white/10">
                        ...
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">Дома на деревьях</span>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden sm:rounded-tr-2xl dark:outline dark:outline-white/10">
                        ...
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">Коттеджи у озера</span>
                        </div>
                      </div>
          ...
          <BentoItem className="col-span-full xl:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>Переходы и анимации</BentoTitle>
                <BentoDescription>
                  Переходы, которые работают так, как вы ожидаете — добавьте несколько утилит к элементу, и вы
                  в деле.
                </BentoDescription>
              </div>
            </BentoHeader>
          ...
          <BentoItem className="col-span-full md:col-span-15 xl:col-span-10">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Поддержка многоязычного текста в разных направлениях больше не кошмар.
                </BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody padding={false} className="h-112">
              ...
              <div className="@container relative isolate flex h-full items-center justify-center">
                <div className="absolute bottom-12 -left-2 z-1 w-[60cqw] shrink-0 divide-y divide-gray-950/5 rounded-xl bg-white shadow-2xl inset-ring inset-ring-gray-950/5 dark:divide-white/5 dark:bg-gray-800 dark:inset-ring-white/5">
                  {[
                    { src: avatar4.src, name: "Уилл Уинтон", role: "Директор по операциям" },
                    { src: avatar5.src, name: "Кристин Ярдли", role: "Координатор маркетинга" },
                    { src: avatar6.src, name: "Эмануэль Куккиттини", role: "Ведущий инженер" },
                    { src: avatar7.src, name: "Киара Смит", role: "Вице-президент по инженерии" },
                  ].map((user, idx) => {
                    return (
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Нет необходимости запоминать этот сложный синтаксис градиентов — создавайте плавные градиенты всего несколькими
              ...
              <div className="-mt-27 -mr-124 -mb-8 bg-white px-6 py-16 ring ring-gray-950/5 md:px-16 xl:-mr-26 dark:bg-gray-950 dark:ring-white/10">
                <div className="flex flex-col gap-2">
                  <span className="text-sm/7 font-medium text-gray-950/75 dark:text-white/75">
                    Мощность встречается с точностью
                  </span>
                  ...
                  <p className="text-lg/7 font-medium text-gray-950/75 dark:text-white/75">
                    Наш движок рендеринга следующего поколения обеспечивает непревзойдённую скорость и эффективность, позволяя создателям
                    выходить за границы как никогда раньше.
                  </p>
                </div>
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>3D трансформации</BentoTitle>
                <BentoDescription>
                  Иногда двух измерений недостаточно. Масштабируйте, поворачивайте и перемещайте любой элемент в 3D пространстве, чтобы добавить
                  нотку глубины.
                </BentoDescription>
              </div>
            </BentoHeader>
