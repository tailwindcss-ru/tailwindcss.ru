          ...
          <BentoItem className="col-span-full">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  Ладно, это не совсем передовая технология, но просто укажите размер экрана буквально перед любой утилитой, чтобы применить ее в определенной контрольной точке.
                </BentoDescription>
              </div>
            </BentoHeader>
