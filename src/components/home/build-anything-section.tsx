  ...
  return (
    <div className="relative max-w-full">
      ...
      <GridContainer className="2xl:before:hidden 2xl:after:hidden">
        <CategoryHeader className="text-fuchsia-500 dark:text-fuchsia-400">Tailwind в дикой природе</CategoryHeader>
      </GridContainer>

      <GridContainer>
        <h2 className="max-w-lg px-2 text-[2.5rem]/10 font-medium tracking-tighter text-balance max-sm:px-4">
          Создавайте все, что хотите, не трогая файл CSS.
        </h2>
      </GridContainer>
      ...
      <GridContainer>
        <p className="max-w-(--breakpoint-md) px-2 text-base/7 text-gray-600 max-sm:px-4 dark:text-gray-400">
          Поскольку Tailwind настолько низкоуровневый, он никогда не поощряет вас разрабатывать один и тот же сайт
          дважды. Некоторые из ваших любимых сайтов созданы с помощью Tailwind, и вы, вероятно, не знали об этом.
        </p>
      </GridContainer>
