  ...
  return (
    <section id="state-variants">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-blue-500">Варианты состояний</Caption>
        <BigText>
          <Widont>Состояния наведения и фокуса? Мы их получили.</Widont>
        </BigText>
        <Paragraph>
          Хотите стилизовать что-нибудь при наведении курсора?
          Поместите <InlineCode>hover:</InlineCode> в начало класса, который вы хотите добавить.
          Работает для <InlineCode>focus</InlineCode>,{' '}
          ...
          и даже причудливые состояния, которые мы придумали сами,
            ...
            <section>
              <header className="rounded-t-xl space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6 dark:highlight-white/10">
                <div className="flex items-center justify-between">
                  <h2 className="font-semibold text-slate-900 dark:text-white">Проекты</h2>
                  <div
