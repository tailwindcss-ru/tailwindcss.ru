...
Как и в случае с пользовательскими утилитами, вы можете генерировать `responsive`, `hover`, `focus`, `active` и другие [варианты](/docs/hover-focus-and-other-states) своих собственных компонентов, используя директиву `@variants`:
...
Подробнее читайте в [документации директивы @variants](/docs/functions-and-directives#variants).
