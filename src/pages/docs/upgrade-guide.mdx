...
Чтобы узнать больше о том, что нового в Tailwind CSS v3.0, прочтите [Анонс Tailwind CSS v3.0](/blog/tailwindcss-v3) в нашем блоге.
...
### Обратный порядок модификаторов файлов
...
### Базовый слой должен присутствовать
