...
Используйте утилиты `rounded-{s|e|ss|se|es|ee}{-size?}`, чтобы установить радиус границы, используя [логические свойства](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts), которые сопоставляются с соответствующими углами в зависимости от направления текста.
