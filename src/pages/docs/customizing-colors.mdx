...
Если вам интересно, как автоматически генерировать 50–950 оттенков ваших собственных цветов, у нас плохие новости — цвет сложен, и, несмотря на то, что мы испробовали десятки различных инструментов, мы еще не нашли ни одного, который бы хорошо генерировал цветовые палитры, такие как это автоматически.
