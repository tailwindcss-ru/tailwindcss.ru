...
По умолчанию эти цвета будут доступны везде в среде, где вы используете цвета, например, утилиты [цвет текста](/docs/text-color), утилиты [цвет границы](/docs/border-color), утилиты [цвет фона](/docs/text-color) и многое другое.
