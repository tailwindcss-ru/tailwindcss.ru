...
description: "Утилиты для управления выравниванием привязки прокрутки элемента."
---
...
Используйте утилиту `snap-center`, чтобы привязать элемент к его центру при прокрутке внутри контейнера привязки.
...
Используйте утилиту `snap-start`, чтобы привязать элемент к его началу при прокрутке внутри контейнера точки.
...
Используйте утилиту `snap-end`, чтобы привязать элемент к его концу при прокрутке внутри контейнера привязки.

<Example p="none" hint="Прокрутите сетку изображений, чтобы увидеть ожидаемое поведение">
  <!-- Snap Point -->
  <div class="mr-6 flex items-end justify-end pt-10 mb-6">
    <div class="mr-2 rounded font-mono text-[0.625rem] leading-6 px-1.5 ring-1 ring-inset bg-indigo-50 text-indigo-600 ring-indigo-600 dark:bg-indigo-500 dark:ring-0 dark:text-white dark:highlight-white/10">точка привязки</div>
