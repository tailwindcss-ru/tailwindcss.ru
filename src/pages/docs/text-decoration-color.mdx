...
Используйте утилиты `decoration-{color}` , чтобы изменить цвет [текстового оформления элемента](/docs/text-decoration).
...
Управляйте непрозрачностью цвета оформления текста элемента с помощью модификатора непрозрачности цвета.
