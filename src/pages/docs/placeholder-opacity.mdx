---
title: "Прозрачность заполнителя"
shortTitle: "Placeholder Opacity"
description: "Утилиты для управления непрозрачностью цвета заполнителя элемента."
---
...
Чтобы управлять прозрачностью цвета заполнителя элемента в определенной контрольной точке, добавьте префикс `{screen}:` к любой существующей утилите прозрачности цвета заполнителя. Например, используйте `md:placeholder-opacity-50`, чтобы применить утилиту `placeholder-opacity-50` только при средних размерах экрана и выше.
...
Если Вы хотите настроить только утилиты непрозрачности заполнителя, используйте раздел `placeholderOpacity`:
