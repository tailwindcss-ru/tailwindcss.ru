...
Для простых проектов или просто для пробуждения Tailwind вы можете использовать инструмент Tailwind CLI для генерации CSS без настройки PostCSS или даже без установки Tailwind в качестве зависимости, если вы этого не хотите.
