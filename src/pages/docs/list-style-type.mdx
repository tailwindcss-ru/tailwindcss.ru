  ...
  <div class="flex flex-col gap-8">
    <div>
      ...
      <ul class="list-disc list-inside text-slate-900 dark:text-slate-200">
        <li>Это история о том, как моя жизнь перевернулась с ног на голову</li>
        <li>И я хотел бы уделить минутку и посидеть здесь</li>
        <li>Я расскажу вам, как я стал князем городка Бель-Эйр</li>
      </ul>
    </div>
    <div>
