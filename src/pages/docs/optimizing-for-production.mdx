...
Для минимальной производственной сборки мы рекомендуем минимизировать CSS с помощью такого инструмента, как [cssnano](https://cssnano.co/), и сжать CSS с помощью [Brotli](https://en.wikipedia.org/wiki/Brotli).
...
Если вы используете фреймворк, проверьте документацию, так как это часто выполняется автоматически в производственной среде, и вам даже не нужно ее настраивать.
