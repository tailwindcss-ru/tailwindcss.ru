...
Прочтите документацию Tailwind CSS по адресу [упорядочивание сложенных модификаторов](https://tailwindcss.ru/docs/hover-focus-and-other-states#ordering-stacked-modifiers), чтобы узнать больше.
