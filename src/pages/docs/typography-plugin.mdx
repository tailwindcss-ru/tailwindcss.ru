...
<a href="https://play.tailwindcss.com/uj1vGACRJA?layout=preview">
  <img src={require('@/img/typography-demo.jpg').default} alt="Расширение Tailwind CSS IntelliSense для Visual Studio Code" width={3086} height={1658} className="rounded-lg ring-1 ring-black/5" />
</a>
