...
Используйте `justify-self-start`, чтобы выровнять элемент сетки по началу его встроенной оси:
...
Используйте `justify-self-end`, чтобы выровнять элемент сетки по концу его встроенной оси:
