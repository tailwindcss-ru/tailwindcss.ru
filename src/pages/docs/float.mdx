...
Используйте [логические свойства](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts) `float-start` или `float-end`, которые отображаются либо слева, либо слева правая сторона в зависимости от направления текста.
