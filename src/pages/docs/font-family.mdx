...
При желании вы можете указать [font-feature-settings](https://developer.mozilla.org/en-US/docs/Web/CSS/font-feature-settings) для каждого шрифта в вашем проекте, используя кортеж форма `[fontFamilies, { fontFeatureSettings }]` при настройке пользовательских шрифтов.
