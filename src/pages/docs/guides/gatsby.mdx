...
Прочтите [документацию Gatsby по использованию глобальных стилей](https://www.gatsbyjs.com/tutorial/part-two/#using-global-styles), чтобы узнать больше о работе с глобальными файлами CSS в Gatsby.
