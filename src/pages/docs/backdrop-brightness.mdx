...
Вы можете настроить, какие утилиты `backdrop-brightness` будут генерироваться, используя ключ `backdropBrightness` в разделе `theme` вашего файла `tailwind.config.js`.
