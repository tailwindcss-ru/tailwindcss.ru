...
Используйте утилиты `break-after-{value}` для управления поведением разрыва столбца или страницы после элемента. Например, используйте утилиту `break-after-column` для принудительного разрыва столбца после элемента.
