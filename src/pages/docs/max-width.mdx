...
<div class="text-sm **max-w-prose** ...">
  <p>О, да. Это лучшая часть. Он хрустящий, взрывной, здесь кекс вырывается из сковороды и делает свое дело. Я вам скажу. Это идея на миллион долларов. Просто продай топы.</p>
</div>
