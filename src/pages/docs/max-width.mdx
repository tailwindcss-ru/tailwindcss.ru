...
По умолчанию максимальный масштаб ширины Tailwind представляет собой комбинацию [масштаба интервала по умолчанию](/docs/customizing-spacing#default-spacing-scale), а также некоторых дополнительных значений, специфичных для ширины.
...
Чтобы настроить `max-width` отдельно, используйте раздел `theme.maxWidth` вашего файла `tailwind.config.js`.
