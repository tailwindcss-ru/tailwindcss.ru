...
Используйте утилиты `break-inside-{value}` для управления поведением столбца или разрыва страницы внутри элемента. Например, используйте служебную программу `break-inside-avoid-column`, чтобы избежать разрыва столбца внутри элемента.
