...
По умолчанию шкала интервалов наследуется от основных плагинов `padding`, `margin`, `width`, `height`, `maxHeight`, `gap`, `inset`, `space`, `translate`, `scrollMargin` и `scrollPadding`.
