...
### Стилизация прямых дочерних элементов <small>(*-{'{modifier}'})</small>
...
<TipBad>Не будет работать, дети не смогут изменить собственный стиль.</TipBad>
...
### Стилизация на основе потомков <small>(has-{'{modifier}'})</small>
...
#### Стилизация на основе потомков группы <small>(group-has-{'{modifier}'})</small>
...
#### Стилизация на основе потомков однорангового узла <small>(peer-has-{'{modifier}'})</small>
...
```html {{ example: { hint: 'Попробуйте эмулировать &#96;prefers-reduced-motion: reduce&#96; в инструментах разработчика, чтобы скрыть спинер' } }}
...
```html {{ example: { p: 'none', hint: 'Попробуйте эмулировать &#96;forced-colors: active&#96; в инструментах разработчика, чтобы увидеть изменения' } }}
<div class="max-w-sm mx-auto bg-white shadow pt-6 pb-4 px-6">
  <form>
