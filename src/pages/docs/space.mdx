...
В таких ситуациях лучше использовать [утилиты промежутков](https://tailwindcss.ru/docs/gap), когда это возможно, или добавить поле к каждому элементу с соответствующим отрицательным полем на родительском элементе:
...
Утилиты `space-*` не предназначены для совместной работы с [утилитами разделения](https://tailwindcss.ru/docs/divide-width). В таких ситуациях рассмотрите возможность добавления для дочерних элементов утилит `margin/padding`.
