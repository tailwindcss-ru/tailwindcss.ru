...
Если вы работаете с какими-либо сторонними библиотеками (например, [Select2](https://select2.org/)) и оформляете эту библиотеку с помощью собственного пользовательского CSS, мы рекомендуем писать эти стили _без_ использования функции `@layer` Tailwind:
