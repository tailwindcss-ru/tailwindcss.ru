...
Используйте утилиты `break-before-{value}` для управления поведением разрыва столбца или страницы перед элементом. Например, используйте утилиту `break-before-column` для принудительного разрыва столбца перед элементом.
