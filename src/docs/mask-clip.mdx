...
export const description = "Утилиты для управления ограничивающим блоком маски элемента.";
...
Используйте утилиты такие как `mask-clip-border`, `mask-clip-padding` и `mask-clip-content` для управления ограничивающим блоком маски элемента:
