...
export const description = "Утилиты для управления отступом прокрутки элемента внутри контейнера с привязкой.";
...
Используйте утилиты `scroll-pt-<number>`, `scroll-pr-<number>`, `scroll-pb-<number>` и `scroll-pl-<number>` как `scroll-pl-4` и `scroll-pt-6` для установки отступа прокрутки элемента внутри контейнера с привязкой:
...
Используйте утилиты `scroll-ps-<number>` и `scroll-pe-<number>` для установки логических свойств `scroll-padding-inline-start` и `scroll-padding-inline-end`, которые отображаются на левую или правую сторону в зависимости от направления текста:
