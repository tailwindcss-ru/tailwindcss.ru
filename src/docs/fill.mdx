...
export const description = "Утилиты для стилизации заливки SVG элементов.";
...
Используйте утилиты типа `fill-indigo-500` и `fill-lime-600` для изменения цвета заливки SVG:
...
Используйте утилиту `fill-current` для установки цвета заливки равным текущему цвету текста:

<Figure hint="Наведите курсор на кнопку, чтобы увидеть изменение цвета заливки">
