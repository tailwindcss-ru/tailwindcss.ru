...
export const description = "Утилиты для управления продолжительностью CSS-переходов.";
...
Используйте утилиты типа `duration-150` и `duration-700`, чтобы установить продолжительность перехода элемента в миллисекундах:
