...
export const description = "Утилиты для управления положением фонового изображения элемента.";
...
Используйте такие утилиты, как `bg-center`, `bg-right` и `bg-top-left`, для управления положением фонового изображения элемента:

<Figure hint="Наведите курсор на эти примеры, чтобы увидеть полное изображение">
