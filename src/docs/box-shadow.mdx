...
<button class="ring ...">Подписаться</button>
<button class="ring-2 ...">Подписаться</button>
<button class="ring-4 ...">Подписаться</button>
```
...
<button class="ring-2 ring-blue-500 ...">Подписаться</button>
...
<button class="inset-ring ...">Подписаться</button>
<button class="inset-ring-2 ...">Подписаться</button>
<button class="inset-ring-4 ...">Подписаться</button>
```
...
<button class="inset-ring-2 inset-ring-blue-500 ...">Подписаться</button>
<button class="inset-ring-2 inset-ring-blue-500/50 ...">Подписаться</button>
```
