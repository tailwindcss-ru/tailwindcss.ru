...
export const description = "Утилиты для установки высоты элемента.";
...
Используйте утилиты `h-<number>` типа `h-24` и `h-64` для установки элемента на фиксированную высоту на основе шкалы интервалов:
...
Используйте утилиты `h-full` или `h-<fraction>` типа `h-1/2` и `h-2/5` для придания элементу высоты на основе процентов:
...
### Соответствие области просмотра

Используйте утилиту `h-screen` для того, чтобы элемент занимал всю высоту области просмотра:
...
### Соответствие динамической области просмотра

Используйте утилиту `h-dvh` для того, чтобы элемент занимал всю высоту области просмотра, которая изменяется при расширении или сжатии пользовательского интерфейса браузера:

<Figure hint="Прокрутите область просмотра, чтобы увидеть изменение высоты области просмотра">
...
### Соответствие большой области просмотра

Используйте утилиту `h-lvh` для установки высоты элемента на максимально возможную высоту области просмотра:
...
### Соответствие малой области просмотра

Используйте утилиту `h-svh` для установки высоты элемента на минимально возможную высоту области просмотра:
...
### Установка ширины и высоты одновременно

Используйте утилиты типа `size-px`, `size-4` и `size-full` для одновременной установки ширины и высоты элемента:
