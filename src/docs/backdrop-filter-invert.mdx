...
export const description = "Утилиты для применения фильтров инверсии к фону элемента.";
...
Используйте утилиты вроде `backdrop-invert` и `backdrop-invert-65` для управления инверсией цвета фона элемента:
