...
export const description = "Утилиты для указания точки отсчета для трансформаций элемента.";
...
Используйте утилиты типа `origin-top` и `origin-bottom-left` для установки точки отсчета трансформации элемента:
