...
export const title = "Колонки";
export const description = "Утилиты для управления количеством столбцов внутри элемента.";
...
Узнайте больше об утилитах gap в [документации по gap](/docs/gap).
