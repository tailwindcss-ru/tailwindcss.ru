...
export const description = "Утилиты для управления цветом курсора ввода текста.";
...
Используйте утилиты типа `caret-rose-500` и `caret-lime-600` для изменения цвета курсора ввода текста:

<Figure hint="Сфокусируйтесь на текстовом поле, чтобы увидеть новый цвет курсора">
