...
export const description = "Утилиты для управления цветом текста элемента.";
...
Используйте утилиты типа `text-blue-600` и `text-sky-400` для управления цветом текста элемента:
...
<Example>
  {
    <div className="relative text-center text-xl leading-6 font-medium">
      <p className="text-blue-600 dark:text-sky-400">Быстрая коричневая лиса перепрыгивает через ленивую собаку.</p>
    </div>
  }
</Example>
...
Используйте модификатор прозрачности цвета для управления прозрачностью цвета текста элемента:
...
<Example>
  {
    <div className="space-y-4 text-center text-xl leading-6 font-medium">
      <p className="text-blue-600/100 dark:text-sky-400/100">Быстрая коричневая лиса перепрыгивает через ленивую собаку.</p>
      <p className="text-blue-600/75 dark:text-sky-400/75">Быстрая коричневая лиса перепрыгивает через ленивую собаку.</p>
      <p className="text-blue-600/50 dark:text-sky-400/50">Быстрая коричневая лиса перепрыгивает через ленивую собаку.</p>
      <p className="text-blue-600/25 dark:text-sky-400/25">Быстрая коричневая лиса перепрыгивает через ленивую собаку.</p>
    </div>
  }
</Example>
