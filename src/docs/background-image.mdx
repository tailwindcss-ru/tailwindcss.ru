...
спользуйте утилиты вроде `bg-linear-to-r` и `bg-linear-<angle>` вместе с [утилитами цветовых остановок](#setting-gradient-color-stops) для добавления линейного градиента к элементу:
