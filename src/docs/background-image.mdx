...
export const description = "Утилиты для управления фоновым изображением элемента.";
...
Используйте утилиты вроде `bg-linear-to-r` и `bg-linear-<angle>` вместе с [утилитами цветовых остановок](#setting-gradient-color-stops) для добавления линейного градиента к элементу:
...
Используйте утилиты `bg-radial` и `bg-radial-[<position>]` вместе с [утилитами цветовых остановок](#setting-gradient-color-stops) для добавления радиального градиента к элементу:
...
Используйте утилиты `bg-conic` и `bg-conic-<angle>` вместе с [утилитами цветовых остановок](#setting-gradient-color-stops) для добавления конического градиента к элементу:
