...
<Example>
  {
    <div className="relative mx-auto flex max-w-sm items-center gap-6 overflow-visible rounded-xl bg-white ring-1 shadow-lg ring-black/5 dark:bg-gray-800">
      <img
...
<Example>
  {
    <div className="relative mx-auto flex max-w-sm items-center gap-6 overflow-hidden rounded-xl bg-white ring-1 shadow-lg ring-black/5 dark:bg-gray-800">
      <img
        className="absolute -left-6 h-24 w-24 rounded-full shadow-lg"
        src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
      />
...
<Example>
  {
    <div className="relative mx-auto flex h-72 max-w-sm flex-col divide-y divide-gray-200 overflow-auto rounded-xl bg-white ring-1 shadow-lg ring-black/5 dark:divide-gray-200/5 dark:bg-gray-800">
...
<Example>
  {
    <div className="relative mx-auto flex h-72 max-w-sm flex-col divide-y divide-gray-200 overflow-y-auto rounded-xl bg-white ring-1 shadow-lg ring-black/5 dark:divide-gray-200/5 dark:bg-gray-800">
      <div className="flex items-center gap-4 p-4">
        <img
          className="h-12 w-12 rounded-full"
          src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
...
<Example>
  {
    <div className="relative mx-auto flex h-72 max-w-sm flex-col divide-y divide-gray-200 overflow-y-scroll rounded-xl bg-white ring-1 shadow-lg ring-black/5 dark:divide-gray-200/5 dark:bg-gray-800">
      <div className="flex items-center gap-4 p-4">
        <img
          className="h-12 w-12 rounded-full"
          src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80"
