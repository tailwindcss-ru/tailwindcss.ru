...
export const description = "Утилиты для применения фильтров сепии к элементу.";
...
Используйте утилиты типа `sepia` и `sepia-50` для управления эффектом сепии, применяемым к элементу:
