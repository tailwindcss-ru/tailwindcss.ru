...
export const description = "Утилиты для применения фильтров яркости к элементу.";
...
Используйте утилиты типа `brightness-50` и `brightness-100` для управления яркостью элемента:
