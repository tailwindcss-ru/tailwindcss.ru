...
export const description = "Утилиты для применения фильтров поворота оттенка к элементу.";
...
Используйте утилиты типа `hue-rotate-90` и `hue-rotate-180` для поворота оттенка элемента на градусы:
...
Используйте утилиты типа `-hue-rotate-15` и `-hue-rotate-45` для установки отрицательного значения поворота оттенка:
