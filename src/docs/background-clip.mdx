...
export const description = "Утилиты для управления ограничивающей рамкой фона элемента.";
...
Используйте утилиты `bg-clip-border`, `bg-clip-padding` и `bg-clip-content` для управления ограничивающей рамкой фона элемента:
...
Используйте утилиту `bg-clip-text` для обрезки фона элемента по форме текста:
