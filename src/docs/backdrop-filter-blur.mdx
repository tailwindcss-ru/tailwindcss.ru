...
export const description = "Утилиты для применения эффекта размытия фона к элементу.";
...
Используйте утилиты вроде `backdrop-blur-sm` и `backdrop-blur-lg` для управления размытием фона элемента:
