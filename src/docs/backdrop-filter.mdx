...
export const description = "Утилиты для применения фильтров к фону элемента.";
...
Вы можете комбинировать следующие утилиты фильтров фона: [размытие](/docs/backdrop-filter-blur), [яркость](/docs/backdrop-filter-brightness), [контрастность](/docs/backdrop-filter-contrast), [оттенки серого](/docs/backdrop-filter-grayscale), [поворот оттенка](/docs/backdrop-filter-hue-rotate), [инверсия](/docs/backdrop-filter-invert), [прозрачность](/docs/backdrop-filter-opacity), [насыщенность](/docs/backdrop-filter-saturate) и [сепия](/docs/backdrop-filter-sepia).
