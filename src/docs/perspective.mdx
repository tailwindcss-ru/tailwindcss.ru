...
export const description = "Утилиты для управления перспективой элемента при размещении в 3D пространстве.";
...
Используйте утилиты такие как `perspective-normal` и `perspective-distant` для управления тем, насколько близко или далеко z-плоскость находится от экрана:
...
Это похоже на приближение или удаление камеры от объекта.

### Удаление перспективы

Используйте утилиту `perspective-none` для удаления перспективного преобразования из элемента:
