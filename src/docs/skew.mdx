...
export const description = "Утилиты для наклона элементов с помощью transform.";
...
Используйте утилиты `skew-<number>` как `skew-4` и `skew-10` для наклона элемента по обеим осям:
...
Используйте утилиты `skew-x-<number>` как `skew-x-4` и `-skew-x-10` для наклона элемента по оси X:
...
Используйте утилиты `skew-y-<number>` как `skew-y-4` и `-skew-y-10` для наклона элемента по оси Y:
