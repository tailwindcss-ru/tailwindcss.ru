...
export const description = "Утилиты для применения фильтров оттенков серого к фону элемента.";
...
Используйте утилиты вроде `backdrop-grayscale-50` и `backdrop-grayscale` для управления эффектом оттенков серого, применяемым к фону элемента:
