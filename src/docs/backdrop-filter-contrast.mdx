...
export const description = "Утилиты для применения фильтров контрастности фона к элементу.";
...
Используйте утилиты вроде `backdrop-contrast-50` и `backdrop-contrast-100` для управления контрастностью фона элемента:
