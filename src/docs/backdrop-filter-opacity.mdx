...
export const description = "Утилиты для применения фильтров прозрачности к фону элемента.";
...
Используйте утилиты вроде `backdrop-opacity-50` и `backdrop-opacity-75` для управления прозрачностью всех фильтров фона, применяемых к элементу:
