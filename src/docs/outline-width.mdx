...
export const description = "Утилиты для управления шириной контура элемента.";
...
<button class="outline outline-offset-2 ...">Кнопка A</button>
<button class="outline-2 outline-offset-2 ...">Кнопка B</button>
<button class="outline-4 outline-offset-2 ...">Кнопка C</button>
```
...
<Figure hint="Сфокусируйтесь на кнопке, чтобы увидеть добавленный контур">
