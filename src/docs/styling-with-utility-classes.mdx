...
<Example resizable>
  {
    <div className="mx-auto max-w-sm space-y-2 rounded-xl bg-white px-8 py-8 ring shadow-lg ring-black/5 @sm:flex @sm:items-center @sm:gap-x-6 @sm:space-y-0 @sm:py-4">
      <img
...
Вы удивитесь, как часто это оказывается лучшим решением. Если вы можете быстро отредактировать все дублирующиеся списки классов одновременно, нет никакой пользы в введении какой-либо дополнительной абстракции.
