...
export const description = "Утилиты для управления точкой схода перспективы элемента при размещении в 3D пространстве.";
...
Используйте утилиты такие как `perspective-origin-top` и `perspective-origin-bottom-left` для управления расположением точки схода перспективы:
