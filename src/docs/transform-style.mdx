...
export const description = "Утилиты для управления тем, размещаются ли дочерние элементы в 3D пространстве.";
...
Используйте `transform-3d` для размещения дочерних элементов в 3D пространстве:
...
Без этого любые дочерние элементы будут трансформироваться только в 2D пространстве, а не в 3D пространстве.
