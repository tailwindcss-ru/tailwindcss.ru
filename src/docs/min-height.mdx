...
export const description = "Утилиты для установки минимальной высоты элемента.";
...
Используйте утилиты `min-h-<number>` такие как `min-h-24` и `min-h-64` для установки элемента на фиксированную минимальную высоту на основе шкалы отступов:
...
Используйте утилиты `min-h-full` или `min-h-<fraction>` такие как `min-h-1/2` и `min-h-2/5` для установки элемента на минимальную высоту на основе процентов:
