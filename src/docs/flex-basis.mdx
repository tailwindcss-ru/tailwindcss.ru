...
export const description = "Утилиты для управления начальным размером flex элементов.";
...
Используйте утилиты `basis-<number>` типа `basis-64` и `basis-128` для установки начального размера flex элементов на основе шкалы отступов:
...
Используйте утилиты типа `basis-xs` и `basis-sm` для установки начального размера flex элементов на основе шкалы контейнеров:
...
Используйте утилиты `basis-<fraction>` типа `basis-1/2` и `basis-2/3` для установки начального размера flex элементов:
