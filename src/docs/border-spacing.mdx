...
export const description = "Утилиты для управления расстоянием между границами таблицы.";
...
Используйте утилиты `border-spacing-<number>` вроде `border-spacing-2` и `border-spacing-x-3` для управления пространством между границами ячеек таблицы с [раздельными границами](/docs/border-collapse#separating-table-borders):
