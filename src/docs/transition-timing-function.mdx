...
export const description = "Утилиты для управления функцией ускорения CSS-переходов.";
...
<button class="duration-300 ease-in ...">Кнопка A</button>
<button class="duration-300 ease-out ...">Кнопка B</button>
<button class="duration-300 ease-in-out ...">Кнопка C</button>
```
