...
export const description = "Утилиты для управления стилем курсора при наведении на элемент.";
...
<Figure hint="Наведите на каждую кнопку, чтобы увидеть изменение курсора">
