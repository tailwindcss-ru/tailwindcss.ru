...
export const description = "Утилиты для управления тем, как элемент может прокручиваться и масштабироваться на сенсорных экранах.";
...
Используйте утилиты типа `touch-pan-y` и `touch-pinch-zoom` для управления тем, как элемент может прокручиваться (панорамироваться) и масштабироваться (сжиматься) на сенсорных экранах:

<Figure hint="Попробуйте панорамировать эти изображения на сенсорном экране">
