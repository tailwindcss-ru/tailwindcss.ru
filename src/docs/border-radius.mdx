...
export const description = "Утилиты для управления скруглением углов элемента.";
...
Используйте утилиты вроде `rounded-s-md` и `rounded-se-xl` для установки скругления углов с помощью [логических свойств](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts), которые соответствуют определенным углам в зависимости от направления текста:
