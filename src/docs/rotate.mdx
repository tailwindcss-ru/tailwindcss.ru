...
export const description = "Утилиты для поворота элементов.";
...
Используйте утилиты `rotate-<number>`, такие как `rotate-45` и `rotate-90`, чтобы повернуть элемент на заданное количество градусов:
...
Используйте утилиты `-rotate-<number>`, такие как `-rotate-45` и `-rotate-90`, чтобы повернуть элемент против часовой стрелки на заданное количество градусов:
...
Используйте утилиты `rotate-x-<number>`, `rotate-y-<number>`, и `rotate-z-<number>`, такие как `rotate-x-50`, `-rotate-y-30` и `rotate-z-45`, чтобы повернуть элемент в 3D пространстве:
