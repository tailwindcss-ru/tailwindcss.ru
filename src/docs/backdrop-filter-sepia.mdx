...
export const description = "Утилиты для применения фильтров сепии к фону элемента.";
...
Используйте утилиты вроде `backdrop-sepia` и `backdrop-sepia-50` для управления эффектом сепии, применяемым к фону элемента:
