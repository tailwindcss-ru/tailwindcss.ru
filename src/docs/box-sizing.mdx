...
export const description = "Утилиты для управления тем, как браузер должен вычислять общий размер элемента.";
...
Tailwind делает это поведением по умолчанию для всех элементов в наших [базовых стилях preflight](/docs/preflight).
