...
export const description = "Утилиты для управления размером неявно созданных строк сетки.";
...
Используйте утилиты типа `auto-rows-min` и `auto-rows-max` для управления размером неявно созданных строк сетки:
