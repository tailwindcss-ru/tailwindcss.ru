...
export const description = "Утилиты для применения фильтров яркости фона к элементу.";
...
Используйте утилиты вроде `backdrop-brightness-50` и `backdrop-brightness-100` для управления яркостью фона элемента:
