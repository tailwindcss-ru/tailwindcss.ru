...
export const description = "Утилиты для управления алгоритмом построения таблицы.";
...
Используйте утилиту `table-auto` для автоматического определения ширины столбцов таблицы по содержимому ячеек:
...
### Использование фиксированной ширины столбцов

Используйте утилиту `table-fixed`, чтобы игнорировать содержимое ячеек таблицы и использовать фиксированную ширину для каждого столбца:
...
Вы можете вручную задать ширину для некоторых столбцов, и оставшаяся доступная ширина будет равномерно распределена между столбцами без явной ширины. Ширина, заданная в первой строке, будет применяться ко всему столбцу.
