...
export const description = "Утилиты для управления стилем границ элемента.";
...
Используйте утилиты вроде `border-solid` и `border-dotted` для управления стилем границы элемента:
...
Используйте утилиту `border-none` для удаления существующей границы элемента:
...
Чаще всего это используется для удаления стиля границы, который был применен на меньшем брейкпоинте.

### Установка стиля разделителя

Используйте такие утилиты, как `divide-dashed` и `divide-dotted`, для управления стилем границы между дочерними элементами:
