...
export const description =
  "Утилиты для управления способом смешивания фонового изображения элемента с его фоновым цветом.";
...
Используйте утилиты вроде `bg-blend-difference` и `bg-blend-saturation` для управления способом смешивания фонового изображения и цвета элемента:
