...
export const description = "Утилиты для управления отступом контура элемента.";
...
<button class="outline-2 outline-offset-0 ...">Кнопка A</button>
<button class="outline-2 outline-offset-2 ...">Кнопка B</button>
<button class="outline-2 outline-offset-4 ...">Кнопка C</button>
```
