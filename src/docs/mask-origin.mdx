...
export const description =
  "Утилиты для управления тем, как изображение маски элемента позиционируется относительно границ, отступов и содержимого.";
...
Используйте утилиты такие как `mask-origin-border`, `mask-origin-padding` и `mask-origin-content` для управления тем, где отображается маска элемента:
