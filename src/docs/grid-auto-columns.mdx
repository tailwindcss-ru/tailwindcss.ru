...
export const description = "Утилиты для управления размером неявно созданных столбцов сетки.";
...
Используйте утилиты типа `auto-cols-min` и `auto-cols-max` для управления размером неявно созданных столбцов сетки:
