...
export const description = "Утилиты для установки минимальной ширины элемента.";
...
Используйте утилиты `min-w-<number>` такие как `min-w-24` и `min-w-64` для установки элемента на фиксированную минимальную ширину на основе шкалы отступов:
...
Используйте утилиты `min-w-full` или `min-w-<fraction>` такие как `min-w-1/2` и `min-w-2/5` для установки элемента на минимальную ширину на основе процентов:
...
Используйте утилиты такие как `min-w-sm` и `min-w-xl` для установки элемента на фиксированную минимальную ширину на основе шкалы контейнеров:
