...
export const description = "Лучшие практики для добавления своих собственных пользовательских стилей в проекты Tailwind.";
...
Если вам нужно применить несколько вариантов одновременно, используйте вложенность:
