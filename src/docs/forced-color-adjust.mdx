...
export const description = "Утилиты для включения и исключения принудительных цветов.";
...
### Исключение принудительных цветов

Используйте утилиту `forced-color-adjust-none` для исключения элемента из цветов, навязываемых режимом принудительных цветов. Это полезно в ситуациях, когда навязывание ограниченной цветовой палитры ухудшит удобство использования.
...
Вы также можете использовать [вариант принудительных цветов](/docs/hover-focus-and-other-states#forced-colors) для условного добавления стилей, когда пользователь включил режим принудительных цветов.

### Восстановление принудительных цветов

Используйте утилиту `forced-color-adjust-auto` для того, чтобы элемент следовал цветам, навязываемым режимом принудительных цветов:
...
Это может быть полезно, если вы хотите отменить утилиту `forced-color-adjust-none`, например, на экране большего размера.
