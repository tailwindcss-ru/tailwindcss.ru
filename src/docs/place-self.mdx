...
export const description =
  "Утилиты для управления тем, как отдельный элемент выравнивается и распределяется одновременно.";
...
Используйте `place-self-auto` для выравнивания элемента на основе значения свойства `place-items` контейнера:
...
Используйте `place-self-start` для выравнивания элемента в начале на обеих осях:
...
Используйте `place-self-center` для выравнивания элемента в центре на обеих осях:
...
Используйте `place-self-end` для выравнивания элемента в конце на обеих осях:
...
Используйте `place-self-stretch` для растягивания элемента на обеих осях:
