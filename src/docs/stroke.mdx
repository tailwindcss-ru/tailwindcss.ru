...
export const description = "Утилиты для стилизации обводки SVG элементов.";
...
Используйте утилиты как `stroke-indigo-500` и `stroke-lime-600` для изменения цвета обводки SVG:
...
Используйте утилиту `stroke-current` для установки цвета обводки в текущий цвет текста:

<Figure hint="Наведите курсор на кнопку, чтобы увидеть изменение цвета обводки">
