...
export const title = "Цвета";
export const description = "Использование и настройка цветовой палитры в проектах Tailwind CSS.";

Tailwind CSS включает обширную, красивую цветовую палитру из коробки, тщательно созданную экспертами-дизайнерами и подходящую для широкого спектра различных стилей дизайна.
...
Каждый цвет в палитре по умолчанию включает 11 ступеней, где 50 является самым светлым, а 950 — самым темным:
...
Теперь утилиты типа `bg-midnight`, `text-tahiti` и `fill-bermuda` будут доступны в вашем проекте в дополнение к цветам по умолчанию.

## Работа с цветами

### Использование цветовых утилит

Используйте цветовые утилиты типа `bg-white`, `border-pink-300` и `text-gray-950` для установки различных цветовых свойств элементов в вашем дизайне:
...
Вот полный список утилит, которые используют вашу цветовую палитру:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Устанавливает <a href="/docs/background-color">цвет фона</a> элемента
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/text-color">цвет текста</a> элемента
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/text-decoration-color">цвет декорации текста</a> элемента
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/border-color">цвет границы</a> элемента
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/outline-color">цвет контура</a> элемента
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает цвет <a href="/docs/box-shadow#setting-the-shadow-color">теней блока</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает цвет <a href="/docs/box-shadow#setting-the-inset-shadow-color">внутренних теней блока</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает цвет <a href="/docs/box-shadow#setting-the-ring-color">кольцевых теней</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает цвет <a href="/docs/box-shadow#setting-the-inset-ring-color">внутренних кольцевых теней</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/accent-color">акцентный цвет</a> элементов управления формы
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/caret-color">цвет курсора</a> в элементах управления формы
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/fill">цвет заливки</a> SVG элементов
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Устанавливает <a href="/docs/stroke">цвет обводки</a> SVG элементов
      </td>
    </tr>
  </tbody>
</table>
...
Вы можете настроить прозрачность цвета, используя синтаксис типа `bg-black/75`, где `75` устанавливает альфа-канал цвета на 75%:
...
Этот синтаксис также поддерживает произвольные значения и сокращение CSS-переменных:
...
Используйте вариант `dark` для написания классов типа `dark:bg-gray-800`, которые применяют цвет только когда активен темный режим:
      ...
      <div className="p-8 pt-7">
        ...
        <div className="rounded-lg bg-white px-6 py-8 shadow-xl ring ring-gray-900/5">
          ...
          <p
            ...
            children={`Ручка Zero Gravity может использоваться для письма в любом направлении,
          включая вверх ногами. Она даже работает в космическом пространстве.`}
          />
        </div>
      </div>
...
Узнайте больше о стилизации для темного режима в [документации по темному режиму](/docs/dark-mode).

### Ссылки в CSS

Цвета представлены как CSS-переменные в пространстве имен `--color-*`, поэтому вы можете ссылаться на них в CSS с помощью переменных типа `--color-blue-500` и `--color-pink-700`:
...
Вы также можете использовать их как [произвольные значения]() в утилитарных классах:
...
Для быстрой настройки прозрачности цвета при ссылке на него как на переменную в CSS, Tailwind включает специальную функцию <code>--alpha()</code>:
...
Узнайте больше о переменных темы в [документации по переменным темы](/docs/theme).

### Переопределение цветов по умолчанию

Переопределите любой из цветов по умолчанию, определив новые переменные темы с тем же именем:
...
### Отключение цветов по умолчанию

Отключите любой цвет по умолчанию, установив пространство имен темы для этого цвета в `initial`:
...
Это особенно полезно для удаления соответствующих CSS-переменных из вашего вывода для цветов, которые вы не планируете использовать.

### Использование пользовательской палитры

Используйте `--color-*: initial` для полного отключения всех цветов по умолчанию и определения собственной пользовательской цветовой палитры:
...
Используйте `@theme inline` при определении цветов, которые ссылаются на другие цвета:
...
Узнайте больше в документации по теме о [ссылках на другие переменные](/docs/theme#referencing-other-variables).

## Справочник цветовой палитры по умолчанию

Вот полный список цветов по умолчанию и их значений для справки:
...
Это может быть полезно, если вы хотите повторно использовать любую из этих шкал, но под другим именем, например, переопределить `--color-gray-*` для использования шкалы `--color-slate-*`.
