...
В v3 любые пользовательские классы, которые вы определяли внутри `@layer utilities`, распознавались Tailwind как настоящие утилитарные классы и автоматически работали с вариантами, такими как `hover`, `focus` или `lg`.
