...
export const description = "Утилиты для управления тем, реагирует ли элемент на события указателя.";
...
<Figure hint="Нажмите на иконки поиска, чтобы увидеть ожидаемое поведение">
