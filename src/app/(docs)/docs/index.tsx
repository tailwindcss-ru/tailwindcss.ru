export default {
  ...
  "Основные концепции": [
    ["Стилизация с помощью утилитарных классов", "/docs/styling-with-utility-classes"],
    ["Наведение, фокус и другие состояния", "/docs/hover-focus-and-other-states"],
    ["Адаптивный дизайн", "/docs/responsive-design"],
    ["Темный режим", "/docs/dark-mode"],
    ["Переменные темы", "/docs/theme"],
    ["Цвета", "/docs/colors"],
    ["Добавление пользовательских стилей", "/docs/adding-custom-styles"],
